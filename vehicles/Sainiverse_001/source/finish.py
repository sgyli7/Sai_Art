...
def write(O):
 ...
 style=json.loads((O/'style.json').read_text());style['name']='Sainiverse 001 / 赛思黑 001';style['theme']='black';style['basis']='Hand-painted semantic panel atlas; matte toon bands and inherited dynamic track ink; no stochastic paint normal.';style['palette']['deck_steel']='61676B'
 ...
 for key,label,color in [('black','黑色','202124'),('desert','沙漠','B29A77'),('white','白色','D9DCD7'),('blue','蓝色','315B78')]:
  ...
  out=dict(id=key,name=label,vehicle_name_en='Sainiverse 001',vehicle_name_zh='赛思黑 001',palette=palette,deck_color='61676B',crane_color='D5AD3D')
