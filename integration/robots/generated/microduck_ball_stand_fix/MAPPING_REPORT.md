...
- MJCF: `/home/ethan/Projects/microduck_rl/src/mjlab_microduck/robot/microduck/scene_ball.xml`
- bodies: 17  joints: 16  actuators: 14
...
- {'geom': 'ball_geom', 'action': 'SphereShape3D r=0.035'}
- {'geom': 'ball_geom', 'action': 'visual SphereMesh r=0.035'}
...
- {'body': 'ball', 'action': 'RigidBody3D mass=0.015 inertia=(1.225e-05,1.225e-05,1.225e-05) layer=1 mask=1'}
- {'joint': 'trunk_base_freejoint', 'action': 'skip type=free'}
- {'joint': 'left_hip_yaw', 'action': 'HingeJoint3D trunk_base->yaw2roll limit=[-0.5236,0.4363] damping=0.053'}
...
- {'joint': 'neck_pitch', 'action': 'HingeJoint3D trunk_base->neck limit=[-1.047,1.571] damping=0.053'}
...
- {'joint': 'right_hip_yaw', 'action': 'HingeJoint3D trunk_base->bearing_roll limit=[-0.4363,0.5236] damping=0.053'}
...
- {'joint': 'ball_free', 'action': 'skip type=free'}
