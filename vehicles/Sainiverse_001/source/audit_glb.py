...
O=Path(__file__).resolve().parents[1];raw=(O/'assets/sainiverse001.glb').read_bytes();n=struct.unpack_from('<I',raw,12)[0];g=json.loads(raw[20:20+n]);data=memoryview(raw)[28+n:]
def accessor(i):
